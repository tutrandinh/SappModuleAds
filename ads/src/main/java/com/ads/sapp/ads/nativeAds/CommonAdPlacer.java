...
import com.ads.sapp.ads.wrapper.StatusAd;
...
public class CommonAdPlacer {
    String TAG = "CommonAdPlacer";
    private HashMap<Integer, ApNativeAd> listAd = new HashMap<>();
    private List<Integer> listPositionAd = new ArrayList<>();
    private CommonAdPlacerSettings settings;
    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private int countLoadAd = 0;

    public CommonAdPlacer(CommonAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
                ...
                holder.itemView.post(() -> {
                    ...
                    Admob.getInstance().loadNativeAd(activity, settings.getAdUnitId(), new AdCallback() {
                        ...
                        public void onUnifiedNativeAdLoaded(@NonNull NativeAd unifiedNativeAd) {
                            ...
                            unifiedNativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                                ...
                                public void onPaidEvent(@NonNull AdValue adValue) {
                                    CommonAdPlacer.this.onAdRevenuePaid(new ApAdValue(adValue));
                                }
                            });

                            CommonAdPlacer.this.onAdLoaded(pos);
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            CommonAdPlacer.this.onAdClicked();
                        }
